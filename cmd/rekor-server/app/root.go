...
func init() {
	...
	rootCmd.PersistentFlags().Bool("enable_stable_checkpoint", false, "publish stable checkpoints to Redis. When disabled, gossiping may not be possible if the log checkpoint updates too frequently")
