...
Memory and file-based signers should only be used for testing.`)
	...
	rootCmd.PersistentFlags().String("scheme", "http", "listener scheme for the API; 'http' or 'https'. Set 'https' to serve TLS")
	...
	// Bind the TLS policy flags to environment variables, mirroring the TLS_*
	// vars the go-swagger server already reads for the cert, key, CA, and port.
