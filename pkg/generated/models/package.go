...
// Package Package in a package manager
//
...
type Package struct {
	...
	// spec
	// Required: true
	Spec PackageSchema `json:"spec"`
}

// Kind gets the kind of this subtype
func (m *Package) Kind() string {
	return "package"
}

// SetKind sets the kind of this subtype
func (m *Package) SetKind(val string) {
}

// UnmarshalJSON unmarshals this object with a polymorphic type from a JSON structure
func (m *Package) UnmarshalJSON(raw []byte) error {
	var data struct {
...
func (m *Package) validateAPIVersion(formats strfmt.Registry) error {
...
func (m *Package) validateSpec(formats strfmt.Registry) error {
