...
const (
	PKIType_PKI_ALGORITHM_UNSPECIFIED PKIType = 0
	PKIType_PGP                       PKIType = 1
	PKIType_MINISIGN                  PKIType = 2
	PKIType_X509                      PKIType = 3
	PKIType_SSH                       PKIType = 4
	PKIType_PKCS7                     PKIType = 5
	PKIType_TUF                       PKIType = 6
)

// Enum value maps for PKIType.
var (
	PKIType_name = map[int32]string{
	...
	PKIType_value = map[string]int32{
...
func (x PKIType) Enum() *PKIType {
	p := new(PKIType)
	*p = x
	return p
}

func (x PKIType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PKIType) Descriptor() protoreflect.EnumDescriptor {
	return file_rekor_common_proto_enumTypes[0].Descriptor()
}

func (PKIType) Type() protoreflect.EnumType {
	return &file_rekor_common_proto_enumTypes[0]
}

func (x PKIType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PKIType.Descriptor instead.
func (PKIType) EnumDescriptor() ([]byte, []int) {
...
type Signature struct {
	...
	Type PKIType `protobuf:"varint,1,opt,name=type,proto3,enum=dev.sigstore.rekor.common.PKIType" json:"type,omitempty"`
	//
...
func (x *Signature) GetType() PKIType {
	if x != nil {
		return x.Type
	}
	return PKIType_PKI_ALGORITHM_UNSPECIFIED
}
...
type Hash struct {
	...
	Algorithm HashAlgorithm `protobuf:"varint,1,opt,name=algorithm,proto3,enum=dev.sigstore.rekor.common.HashAlgorithm" json:"algorithm,omitempty"`
	//
...
var file_rekor_common_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x19, 0x64, 0x65, 0x76, 0x2e, 0x73, 0x69, 0x67, 0x73, 0x74, 0x6f,
	0x72, 0x65, 0x2e, 0x72, 0x65, 0x6b, 0x6f, 0x72, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x22,
	0xa2, 0x01, 0x0a, 0x09, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x12, 0x36, 0x0a,
	...
	0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x50, 0x4b, 0x49, 0x54, 0x79, 0x70, 0x65, 0x52,
	...
	0x43, 0x0a, 0x0a, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x03, 0x20,
	...
	0x63, 0x4b, 0x65, 0x79, 0x22, 0x25, 0x0a, 0x09, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65,
	0x79, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0c, 0x52, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x22, 0x64, 0x0a, 0x04, 0x48,
	0x61, 0x73, 0x68, 0x12, 0x46, 0x0a, 0x09, 0x61, 0x6c, 0x67, 0x6f, 0x72, 0x69, 0x74, 0x68, 0x6d,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x28, 0x2e, 0x64, 0x65, 0x76, 0x2e, 0x73, 0x69, 0x67,
	0x73, 0x74, 0x6f, 0x72, 0x65, 0x2e, 0x72, 0x65, 0x6b, 0x6f, 0x72, 0x2e, 0x63, 0x6f, 0x6d, 0x6d,
	...
	0x65, 0x2a, 0x66, 0x0a, 0x07, 0x50, 0x4b, 0x49, 0x54, 0x79, 0x70, 0x65, 0x12, 0x1d, 0x0a, 0x19,
	...
	0x41, 0x32, 0x35, 0x36, 0x10, 0x01, 0x42, 0x68, 0x0a, 0x19, 0x64, 0x65, 0x76, 0x2e, 0x73, 0x69,
	0x67, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2e, 0x72, 0x65, 0x6b, 0x6f, 0x72, 0x2e, 0x63, 0x6f, 0x6d,
	0x6d, 0x6f, 0x6e, 0x42, 0x10, 0x52, 0x65, 0x6b, 0x6f, 0x72, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e,
...
var file_rekor_common_proto_goTypes = []interface{}{
	(PKIType)(0),       // 0: dev.sigstore.rekor.common.PKIType
	(HashAlgorithm)(0), // 1: dev.sigstore.rekor.common.HashAlgorithm
	(*Signature)(nil),  // 2: dev.sigstore.rekor.common.Signature
	(*PublicKey)(nil),  // 3: dev.sigstore.rekor.common.PublicKey
	(*Hash)(nil),       // 4: dev.sigstore.rekor.common.Hash
}
var file_rekor_common_proto_depIdxs = []int32{
	0, // 0: dev.sigstore.rekor.common.Signature.type:type_name -> dev.sigstore.rekor.common.PKIType
	3, // 1: dev.sigstore.rekor.common.Signature.public_key:type_name -> dev.sigstore.rekor.common.PublicKey
	1, // 2: dev.sigstore.rekor.common.Hash.algorithm:type_name -> dev.sigstore.rekor.common.HashAlgorithm
