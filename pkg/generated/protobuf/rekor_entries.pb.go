...
type LogEntry struct {
	...
	IntegrationTime uint64 `protobuf:"varint,4,opt,name=integration_time,json=integrationTime,proto3" json:"integration_time,omitempty"`
	//
...
func (x *LogEntry) GetIntegrationTime() uint64 {
	if x != nil {
...
func (x *GetLogEntryRequest) GetLogIndex() uint64 {
	if x != nil {
		return x.LogIndex
	}
	return 0
...
type ListLogEntriesRequest struct {
	...
	LogIndices []uint64 `protobuf:"varint,3,rep,packed,name=log_indices,json=logIndices,proto3" json:"log_indices,omitempty"`
}
...
func (x *ListLogEntriesRequest) GetLogIndices() []uint64 {
	if x != nil {
		return x.LogIndices
	}
	return nil
...
var file_rekor_entries_proto_rawDesc = []byte{
	...
	0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0f, 0x69, 0x6e, 0x74, 0x65, 0x67, 0x72, 0x61,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x08, 0x74, 0x72, 0x65, 0x65, 0x53, 0x69, 0x7a, 0x65,
	...
	0x5f, 0x69, 0x6e, 0x64, 0x69, 0x63, 0x65, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x04, 0x52, 0x0a,
