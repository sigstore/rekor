...
func init() {
  ...
  "definitions": {
    ...
    "IntotoV003SchemaProposedContent": {
      "type": "object",
      "required": [
        "envelope",
        "publicKeys"
    ...
    "intotoSchema": {
      ...
      "oneOf": [
        ...
        {
          "$ref": "#/definitions/intotoV003Schema"
        }
      ],
      "$schema": "http://json-schema.org/draft-07/schema",
    ...
    "intotoV003Schema": {
      ...
      "properties": {
        ...
        "signatures": {
          ...
          "minItems": 1,
          "items": {
            "$ref": "#/definitions/IntotoV003SchemaSignaturesItems0"
          },
          "readOnly": true
        }
      },
