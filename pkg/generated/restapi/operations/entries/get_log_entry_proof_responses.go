...
// WithPayload adds the payload to the get log entry proof not found response
func (o *GetLogEntryProofNotFound) WithPayload(payload *models.Error) *GetLogEntryProofNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get log entry proof not found response
func (o *GetLogEntryProofNotFound) SetPayload(payload *models.Error) {
	o.Payload = payload
}
