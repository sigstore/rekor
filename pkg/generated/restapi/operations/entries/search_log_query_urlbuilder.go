...
func (o *SearchLogQueryURL) Build() (*url.URL, error) {
	...
	var _path = "/api/v1/log/entries/retrieve"
...
func (o *SearchLogQueryURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on SearchLogQueryURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on SearchLogQueryURL")
	}
