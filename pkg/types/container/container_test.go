...
func TestContainerType(t *testing.T) {
	...
	// version requested fails to match implementation in map
	u.Container.APIVersion = swag.String("not_a_version")
	if _, err := brt.UnmarshalEntry(&u.Container); err == nil {
