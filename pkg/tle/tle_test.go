...
func TestMarshalAllValues(t *testing.T) {
	type TestCase struct {
		description   string
		expectSuccess bool
		proposedEntry models.LogEntryAnon
	...
	testCases := []TestCase{
		{
			description:   "first entry has all values specified",
			expectSuccess: true,
			proposedEntry: models.LogEntryAnon{
				Body:           "",
				IntegratedTime: new(int64(123)),
				LogID:          new("deadbeef"),
				LogIndex:       new(int64(0)),
				Verification: &models.LogEntryAnonVerification{
					InclusionProof: &models.InclusionProof{
						Checkpoint: new("checkpoint"),
						Hashes:     []string{},
	...
	for _, tc := range testCases {
		t.Run(tc.description, func(t *testing.T) {
			...
			if tc.expectSuccess {
				b, err := MarshalTLEToJSON(e)
				if err != nil {
					t.Fatalf("unexpected result: %v", err)
				}
				if !strings.Contains(string(b), `"logIndex":"0"`) {
					t.Errorf("marshalled value did not explicitly contain default values")
				}
				if !strings.Contains(string(b), `"hashes":[]`) {
					t.Errorf("marshalled value did not explicitly contain default values")
				}
			}
		})
